...
public class AsyncGlobal_latent<NN extends NeuralNet> extends Thread {
	...
	public AsyncGlobal_latent(ActorCriticSeparate initial, int maxStep, int maxRuleLen, int maxRuleNum, double gamma) {
