...
public class AsyncGlobal3<NN extends NeuralNet> extends Thread {
	...
	public AsyncGlobal3(ActorCriticSeparate initial, int maxStep, int maxRuleLen, int maxRuleNum, double gamma) {
