package binghamton.rl.A3C.generator3;
...
public class AsyncThread3<NN extends NeuralNet> extends Thread {
	Random rdm;
...
//	final StandardPredicate dummyPred;
	...
	private NN current;
	private AsyncGlobal3<NN> asyncGlobal;
	
	private ConfigBundle config;
	
	public AsyncThread3(AsyncGlobal3<NN> asyncGlobal, int threadNum,  int maxRuleLen, int maxRuleNum, int nstep, double gamma) {
...
//		this.networkPreds = generator.getNetworkPreds();
