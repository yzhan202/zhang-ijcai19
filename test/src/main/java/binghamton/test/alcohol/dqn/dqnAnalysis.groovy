...
String dataDir = 'data/smallAlcohol'; //'data/alcohol_test';
...
StandardPredicate[] negFeatPreds = [usesAlcoholWord, usesSoberWord, alcoholTopic, soberTopic];
...
mdp.loadDQN(outputPath+ 'dqn.ser')
