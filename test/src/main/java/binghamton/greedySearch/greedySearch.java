...
public class greedySearch {
	...
	public greedySearch(StandardPredicate[] X, StandardPredicate[] Y, StandardPredicate[] Z, 
...
//						}
	...
	public int getDummyUserPredIdx() {
		StandardPredicate dummyPred = (StandardPredicate)PredicateFactory.getFactory().getPredicate("attendsAA");
